...
const WriteArticle = () => {
  const articleLength =[ {length:800, text:'Short (800 words)'},
  ...
  const onSubmitHandler = async (e) =>{ 
    ...
    try {
      setLoading(true);
      const prompt = `Write a detailed blog article about ${input} with a length of around ${selectedLength.text} words.`;
