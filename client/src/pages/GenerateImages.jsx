...
const GenerateImages = () => {
  ...
  const imageStyle =[ 'Realistic', 'Cartoon', '3D Render', 'Pixel Art', 'Line Art', 'Watercolor', 'Oil Painting', 'Surreal style', 'Fantasy style', 'Cyberpunk', 'Ghibli style', 'Anime style', 'Portrait style'];
